...
const QuestList = () => {
  return (
    <div className="grid grid-cols-1 gap-2 p-2 lg:grid-cols-2 md:p-20 min-h-full bg-[#FAFBFB] overflow-hidden">
      <div>
        <div className="flex flex-col md:flex-row md:items-end">
          <div className="flex items-center justify-center flex-col">
            ...
            />
            <img className="w-[200px] mb-7 md:mb-0" src="assets/planet2.png" />
          </div>
          <div>
        ...
        <div className="px-0 py-14 md:px-20">
          <p className="text-lg font-light">
            Social Club is a professional event in a relaxed atmosphere, curated
            for Black & Latinx professionals, and providing them with an
            experience that drives community, career development and
